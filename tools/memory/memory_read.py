...
try:
    from memory_db import get_recent, get_daily_log
except ImportError:
...
def main():
    ...
    scope.add_argument('--memory-only', action='store_true', help='Only load MEMORY.md')
    scope.add_argument('--logs-only', action='store_true', help='Only load daily logs')
